...
languages = {
  sk: {
    ...
    splav_vikend: 'Splav Víkend (Pia,So,Ne): Dospelá osoba s kompletným vybavením: 15,-€',
    splav_tyzden: 'Splav (streda, štvrtok): Dospelá osoba s kompletným vybavením: 12,-€',
    splav_deti: 'Deti do 15 rokov s kompletným vybavením: 10€,-',
    splav_kanoe: 'Kanoe na Kalonde: Prenájom kanoe na vodnom diele Kalonda pre začiatočníkov: 10,-€',
    cennik_paddleboard: 'Paddleboard: Prenájom paddleboardu na VD Kalonda: 5,-€',
    ...
    poznamka_k_cenniku_2: 'V cene prenájmu je zahrnuté kompletné vybavenie (prilby, vesty, pádla, vodotesné vaky, barely).',
  ...
  en: {
    ...
    splav_vikend: 'Weekend (Fri, Sat, Sun): Adult with complete gear: 15,-€',
    splav_tyzden: 'Business day (Wed, Thu): Adult with complete gear: 12,-€',
    splav_deti: 'Children up to 15 years old with complete gear: 10€,-',
    splav_kanoe: 'Kalonda Canoe: Canoe rental on hydraulic structure Kalonda for beginners: 10,-€',
    cennik_paddleboard: 'Paddleboard: Paddleboard on hydraulic structure Kalonda: 5,-€',
    //uplny_cennik_download: 'Úplný cenník na stiahnutie.',
    ...
    poznamka_k_cenniku_2: 'Complete gear (helmet, life jacket, waterproof bag, barrel) is included in rental price.',
