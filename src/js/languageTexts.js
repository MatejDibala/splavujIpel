 ...
 */
 ...
 languages = {
    sk: {
      ...
      kontakty: 'Kontakty',
      ladovo: 'Ľadovo - požičovňa',
      splavuj_ipel: 'Splavuj Ipeľ',
      ...
      answer_3: 'Splav začíname v Kalonde na vodnom diele, kde sa stretávame 15 minút pred začiatkom vášho splavu. Najprv si zaparkujete auto a prídete za nami ku Ipľu. Tu si spravíme inštruktáž s možnosťou vyskúšania kanoe, to isté platí aj pre rafty. Následne si prevezmete vybavenie ako plávacie vesty a samozrejme lode. Prebehne rýchlokurz a popis trasy. Odvezieme vás mikrobusom na začiatok splavu (začiatok kanoe do Holiše, začiatok pre raft do Rapoviec) kde si spravíte fotky a my vás nasadíme do kanoe a pustíme dolu Ipľom.',
      ...
      answer_8: 'Obec Kalonda, hať vodné dielo Kalonda, v mapách ako "Splavuj Ipeľ Kalonda". Za obcou smerom na maďarské hranice odbočíte doprava, cesta je značená. Určite nás neváhajte vopred kontaktovať na telefónnych číslach +421948429625 +421907667287 +421949811809 a my vám pomôžeme sa bezstarostne dostať k nám. Cestou uvidíte farebné značenie, takže nás určite neprehliadnete. V spodnej časti stránky nájdete našu polohu na Google Maps.',
      question_9: 'Kde môžem zaparkovať?',
      answer_9: 'Svoje auto si môžete odparkovať priamo pri vodnom diele Kalonda. Parkovanie je bezplatné.',
      question_10: 'Koľko trvá splav Ipľa?',
      answer_10: 'Trvanie splavu závisí od výšky vodnej hladiny v daný deň a taktiež aj od aktivity účastníkov. Avšak máme odskúšané, že priemerné trvanie splavu z Holiše do Kalondy na kanoe pri normálnych podmienkach je zhruba dve a pol hodiny. (Hlavná trasa splavovania je dlhá 10km a začína v obci Holiša s koncom v obci Kalonda.) Pričom splav na rafte z Rapoviec do Kalondy trvá približne 1,5 hodiny. Pripomíname, že vždy je lepšie splavovať Ipeľ cez týždeň. Všade je menej ľudí, personál je menej nervózny a koniec koncov je to aj lacnejšie.',
      ...
      answer_14: 'Na začiatok splavu vás z Kalondy odvezieme my. Vy si rieku splavíte, a vaše auto počká pohodlne na konci splavu v Kalonde.',
    ...
    en: {
      ...
      information_button: 'Info',
      kontakty: 'Contacts',
      ladovo: 'Ľadovo - rental',
      splavuj_ipel: 'Paddle Ipeľ',
      pozicovna_aut : 'Car rental', 
      ...
      answer_3: 'The beginning for paddling Ipeľ is on hydraulic structure Kalonda, where we meet 15 minutes early (before canoeing time). First, you park your car and come to us at Ipeľ. Afterwards, you will get instructed and you can try coneing or rafting. Then, you will receive the gear such as life vests and canoes (or rafts) of course. You will get description of the route and instructions. We will drive you by microbus to the starting area (Holiša for canoes, Rapovce for rafts), where you take your pictures, we will put you in boats and let you down Ipeľ.',
      ...
      answer_8: 'Town Kalonda, hydraulic structure Kalonda, in maps as "Splavuj Ipeľ Kalonda". After you pass kalonda (direction to Hungary borders), you take a right, there is a sign. Don’t hesitate to contact us beforehand on the numbers +421948429625 +421907667287 +421949811809 and we will help you get to us effortlessly. On the way you will see colour signs, so that you surely won’t miss us. At the bottom of the page you will also find our location in Google Maps.',
      question_9: 'Where can I park my car?',
      answer_9: 'You can park your car right at the hydraulic structure Kalonda. Parking is free.',
      question_10: 'How much time does it take to paddle Ipeľ?',
      answer_10: 'The duration of paddling depends on water level on a given day and also on activity of paddlers. However, we know from our experience that on average it takes approximately two and a half hours to paddle from Holiša to Kalonda, under normal circumstances. (The main route of paddling is 10km long, starts in Holiša and ends in Kalonda). Rafting from Rapovce to Kalonda takes approximately 1.5 hours. We’d like to remind that it is better to paddle Ipeľ on a business day. There are fewer people everywhere, staff is more pleasant and after all, it is cheaper as well.',
      ...
      answer_14: 'We will drive you to the starting point. You will paddle down the river and the car will wait for you at the end of the paddling in Kalonda.',
