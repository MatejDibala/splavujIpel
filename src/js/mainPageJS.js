...
languages = {
  sk: {
    ...
    poznamka_k_cenniku_2: 'V cene prenájmu je zahrnuté kompletné vybavenie: certifikované prilby, vesty, pádla, vodotesné vaky, barely.',
  ...
  en: {
    ...
    poznamka_k_cenniku_2: 'Complete gear: certified helmet, life jacket, waterproof bag, barrel is included in rental price.',
